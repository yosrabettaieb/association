                    ...
                    <div class="row flex-grow">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <div class="row">
                                        <h4>Liste des revenus</h4> <!-- class="card-title"-->
                                        <!-- boutton ajouter un revenu va appeler modal "add"-->
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-4">
                                                            <form class="docDelete"
                                                                  action="{{ action('RevenusController@destroy', $revenu->id)}}"
                                                                  method="POST">
                                                                @method('DELETE')
                                                                @csrf
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form class="forms-sample" action="/revenu" method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            <input type="hidden" class="form-control" id="type" name="type" value="revenu">
        ...
        <div class="modal fade" id="myModal" tabindex="-1" aria-labelledby="exempleModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="content">
                            <!-- <input type="hidden" name="revenu_id" id="id" value="{ {$revenu->id}}">  -->
        ...
        <div class="modal fade" id="edit" role="dialog" tabindex="-1" aria-labelledby="exempleModalLabel"
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <!-- Modal Header -->
                    <div class="modal-header">
                        <h4 class="modal-title">Modifier le revenu</h4>
                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                    </div>
                    <!-- Modal body -->
                    <div class="modal-body">
                        <form class="forms-sample" action="/updateRev" method="post" enctype="multipart/form-data">
                            @method('PUT')
                            @csrf
                            <input type="hidden" name="revenu_id" id="id" value="">
