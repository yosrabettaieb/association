...
@section('content')
    ...
    <div class="main-panel">
                    ...
                    <div class="row flex-grow">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <div class="row">
                                        <h4>Liste des documents financières</h4> <!-- class="card-title"-->
                                        <!-- boutton ajouter un document va appeler modal "add"-->
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="row">
                                                        ...
                                                        <div class="col-3">
                                                            <!--*********boutton edit******************-->
                                                            <a href="/DocumentFinanciere/{{$document->id}}"
                                                        ...
                                                        <div class="col-3">
                                                            ...
                                                            <form class="docDelete"
                                                                  action="{{ action('DocumentsfinancieresController@destroy', $document->id)}}"
                                                                  method="POST">
                                                                @method('DELETE')
                                                                @csrf
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form class="forms-sample" action="/DocumentFinanciere" method="POST"
        ...
        <!-- The Modal -->
        <div class="modal" id="add" tabindex="-1" aria-labelledby="exempleModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">

                    <!-- Modal Header -->
                    <div class="modal-header">
                        <h4 class="modal-title"><h4 class="card-title">Nouveau document financier</h4></h4>
        ...
        <div class="modal fade" id="myModal" tabindex="-1" aria-labelledby="exempleModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="content">
                            <!-- <input type="hidden" name="document_id" id="id" value="{ {$document->id}}">-->
                            <ul class="">
                                <li class="">
        ...
        <div class="modal fade" id="edit" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">modifier document financière</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
...
@section('script.form')
    <script>
        $('#edit').on('show.bs.modal', function (event) {
            ...
            modal.find('.modal-body form').attr('action', '/updatef/' + id)
